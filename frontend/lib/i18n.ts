...
const zhTranslations = {
  ...
  settings_page: {
    ...
    reset: '重置为默认',
    no_changes: '没有修改',
    saved_restart: '已保存，需要重启后端生效',
    saved: '已保存',
    save_failed: '保存失败: {error}',
    reset_confirm: '确定重置所有设置为默认值？',
    reset_done: '已重置为默认值，重启后生效',
    reset_failed: '重置失败: {error}',
    restart_required: '修改需要重启后端生效',
    immediate_effect: '修改即时生效',
    configured: '已配置',
    not_configured: '未配置',
    configure: '配置',
    update: '更新',
...
const enTranslations = {
  ...
  settings_page: {
    ...
    reset_done: 'Reset to defaults, restart required',
    reset_failed: 'Failed: {error}',
    restart_required: 'Changes require backend restart',
    ...
    cancel: 'Cancel',
    language_hint: 'Language can be switched at the bottom of the sidebar',
  },
  // Language Switcher
  language: {
    title: 'Language',
