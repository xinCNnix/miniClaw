...
- External research tools consistently failing (8 consecutive attempts per query with tool errors)
- External research tools consistently failed during all research attempts (8 steps per query reported failures)
